...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Reqwest.swiftmodule/`
...
//      `import Reqwest` above would fail at compile time.
//
//   2. The static archive `libReqwest.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Reqwest" }` and
//      `flattenPackage = "io.github.kotlinmania.reqwest"` configuration in
...
//      via the `ReqwestLibrary` product.
//
