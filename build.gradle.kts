...
kotlin {
    ...
    val xcf = XCFramework("Reqwest")

    macosArm64 {
        binaries.framework { baseName = "Reqwest"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Reqwest"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Reqwest"
        flattenPackage = "io.github.kotlinmania.reqwest"
    }

    android {
        namespace = "io.github.kotlinmania.reqwest"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "reqwest-kotlin", version.toString())

    pom {
        name.set("reqwest-kotlin")
        description.set("Kotlin Multiplatform port of seanmonstar/reqwes - higher level HTTP client library")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/reqwest-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/reqwest-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/reqwest-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/reqwest-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleReqwestXCFramework",
    "assembleReqwestDebugXCFramework",
    "assembleReqwestReleaseXCFramework",
    "assembleDebugIosFatFrameworkForReqwestXCFramework",
    "assembleReleaseIosFatFrameworkForReqwestXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForReqwestXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForReqwestXCFramework",
    "assembleDebugMacosFatFrameworkForReqwestXCFramework",
    "assembleReleaseMacosFatFrameworkForReqwestXCFramework",
    "assembleDebugTvosFatFrameworkForReqwestXCFramework",
    "assembleReleaseTvosFatFrameworkForReqwestXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForReqwestXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForReqwestXCFramework",
    "assembleDebugWatchosFatFrameworkForReqwestXCFramework",
    "assembleReleaseWatchosFatFrameworkForReqwestXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForReqwestXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForReqwestXCFramework",
